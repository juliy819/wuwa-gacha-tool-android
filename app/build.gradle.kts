...
android { namespace = "com.wuwa.gachatool"; compileSdk = 35
    defaultConfig { applicationId = "com.wuwa.gachatool"; minSdk = 26; targetSdk = 35; versionCode = 103; versionName = "0.1.3"; testInstrumentationRunner = "androidx.test.runner.AndroidJUnitRunner"; buildConfigField("String", "ONEDRIVE_CLIENT_ID", "\"${oneDriveClientId.replace("\\", "\\\\").replace("\"", "\\\"")}\"") }
